            ...
            if filename.endswith(".jpg") or filename.endswith(".png") or filename.endswith("jpeg"): 
                ...
                with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
                    ...
                    if results.pose_landmarks is not None:
                        ...
                        csv_writer.writerow([ angles[0], angles[1], angles[2], angles[3], angles[4], angles[5], angles[6], angles[7], angles[8], angles[9], angles[10], angles[11]])
#Change your path
path_input = r'C:\Users\birad\Documents\Embedded\YogaDetection\DATASET\TRAIN\tree'
path_output = r'C:\Users\birad\Documents\Embedded\YogaDetection\DATASET\TRAIN\angle_teacher_yoga1.csv'
